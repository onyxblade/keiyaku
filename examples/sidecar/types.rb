...
module Sidecar
  VerificationMethod = Keiyaku.model({
    id: String,
    type: String,
    controller: String,
  ...
  DIDResolutionResultDidResolutionMetadata = Keiyaku.model({
    content_type: String,
    error: String,
    message: String
  })
  DIDResolutionResult = Keiyaku.model({
    did_document: :any,
    did_document_metadata: { String => :any },
    did_resolution_metadata: DIDResolutionResultDidResolutionMetadata
  }, required: %i[did_document did_document_metadata did_resolution_metadata])
  Attachment = Keiyaku.model({
    data: :any,
    id: String,
    description: String,
    filename: String,
  ...
  PostDidDidcommDocResult = Keiyaku.model({ did_doc: DIDDoc }, required: %i[did_doc])
